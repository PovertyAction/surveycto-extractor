...
def test_nested_two_level_column_contract(tmp_path):
    ...
    form = [
        {"type": "repeat_count", "variable_name": "outer_count",
         "repeat_group_name": "outer", "calculation": "2", "group_path": []},
        {"type": "text", "variable_name": "omem", "group_path": ["outer"]},
        {"type": "repeat_count", "variable_name": "inner_count",
         "repeat_group_name": "inner", "calculation": "3",
         "group_path": ["outer"]},
        {"type": "text", "variable_name": "mem",
    ...
    assert content == [
        "outer_count",
        "omem_1", "omem_2",
        "inner_count_1", "inner_count_2",
        "mem_1_1", "mem_1_2", "mem_1_3",
        "mem_2_1", "mem_2_2", "mem_2_3",
    ]
...
def test_three_level_nesting_grid(tmp_path):
    ...
    form = [
        {"type": "repeat_count", "variable_name": "a_count",
         "repeat_group_name": "a", "calculation": "2", "group_path": []},
        {"type": "repeat_count", "variable_name": "b_count",
         "repeat_group_name": "b", "calculation": "2", "group_path": ["a"]},
        {"type": "repeat_count", "variable_name": "c_count",
         "repeat_group_name": "c", "calculation": "2", "group_path": ["a", "b"]},
        {"type": "text", "variable_name": "leaf",
         "group_path": ["a", "b", "c"]},
    ]
    content, _ = _run(tmp_path, form)
    leaf = [c for c in content if c.startswith("leaf")]
    assert leaf == [
        "leaf_1_1_1", "leaf_1_1_2", "leaf_1_2_1", "leaf_1_2_2",
        "leaf_2_1_1", "leaf_2_1_2", "leaf_2_2_1", "leaf_2_2_2",
    ]
    # c_count is nested two repeats deep -> 2x2 = 4 ancestor-suffixed columns.
    assert [c for c in content if c.startswith("c_count")] == [
        "c_count_1_1", "c_count_1_2", "c_count_2_1", "c_count_2_2",
    ]
...
def test_ragged_inner_count_per_outer_iteration(tmp_path):
    ...
    form = [
        {"type": "repeat_count", "variable_name": "hh_count",
         "repeat_group_name": "hh", "calculation": "3", "group_path": []},
        {"type": "integer", "variable_name": "njobs", "group_path": ["hh"],
         "constraint": ".>=1 and .<=4"},
        {"type": "repeat_count", "variable_name": "job_count",
         "repeat_group_name": "job", "calculation": "${njobs}",
         "group_path": ["hh"]},
        {"type": "text", "variable_name": "jobname",
         "group_path": ["hh", "job"]},
    ]
    ...
    filled = [c for c in content if c.startswith("jobname_") and row[c] not in ("", None)]
...
def test_select_multiple_inside_nested_repeat(tmp_path):
    ...
    form = [
        {"type": "repeat_count", "variable_name": "outer_count",
         "repeat_group_name": "outer", "calculation": "2", "group_path": []},
        {"type": "repeat_count", "variable_name": "inner_count",
         "repeat_group_name": "inner", "calculation": "2",
         "group_path": ["outer"]},
        {"type": "select_multiple", "variable_name": "tags",
         "group_path": ["outer", "inner"],
    ...
    assert tag_cols == [
        "tags_1_1_1", "tags_2_1_1",
        "tags_1_1_2", "tags_2_1_2",
        "tags_1_2_1", "tags_2_2_1",
        "tags_1_2_2", "tags_2_2_2",
    ]
...
def test_single_level_repeat_shape_unchanged(tmp_path):
    ...
    form = [
        {"type": "repeat_count", "variable_name": "r_count",
         "repeat_group_name": "r", "calculation": "3", "group_path": []},
